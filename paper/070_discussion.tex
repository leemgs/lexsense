...
우리의 평가는 다국어 정보 접근 프레임워크 LexSense의 강점과 한계를 모두 부각시키는 동시에, 중요한 윤리적 고려사항과 연구적 함의를 드러낸다. 
...
적용상의 이점뿐만 아니라, \textbf{규제 감지를 위한 LLM 기반 분류체계} 도입은 법률·정부 정보에 대한 포용적 접근이라는 방향에 개념적 기여를 한다.
...
기회와 위험을 모두 조명함으로써, 본 연구는 자연어 처리, 법학, 책임 있는 AI의 교차점에서 \textbf{법률·정부 정보에 대한 포용적 접근}이라는 새로운 연구 방향에 기여한다. 
...
Our evaluation highlights both the strengths and limitations of LexSense, a multilingual information-access framework, while also surfacing important ethical considerations and research implications. 
...
Beyond applied benefits, the introduction of an \textbf{LLM-driven taxonomy for regulatory sensing} represents a conceptual contribution to inclusive access to legal and government information.
...
For researchers, the results establish multilingual information access as a new benchmark task for large language models, encouraging deeper exploration of cross-lingual, fairness-aware, and explainable approaches. 
...
By highlighting both opportunities and risks, this work contributes to \textbf{inclusive access to legal and government information}—a direction at the intersection of NLP, law, and responsible AI. 
